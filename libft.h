...
/*   Updated: 2022/11/23 16:05:31 by anrodri2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// strlcat : appends src to the end of dst. It will append at most size - strlen(dst) - 1 bytes
...
// strnstr : Locates the first occurence of the string needle in haystack in n chars
char	*ft_strnstr(const char *haystack, const char *needle, size_t n);
// strrchr : Finds the last occurence of the char c in the string
char	*ft_strrchr(const char *s, int c);
// substr : Returns a string that starts from index start until len chars from the string s
